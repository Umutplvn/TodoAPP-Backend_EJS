...
module.exports = {
    ...
    list: async (req, res) => {
        ...
        // console.log(data)
        res.render('todoList', { data, priority })  // public/todoList dosyasini render edecek / template islemleri icin res.render('...') kullanilir
        //! res.render('todoList', { data, priority })  template olarak render yap('public icindeki html-css formatimiz', {yazdirilmak istenen data ve priority verisini todoListe yolla})
    },
